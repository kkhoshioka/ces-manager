...
const SupplierMonthlyReport = () => {
    ...
    const copyItem = (index: number) => {
        const itemToCopy = purchaseForm.items[index];
        const newItems = [...purchaseForm.items];
        newItems.splice(index + 1, 0, { ...itemToCopy, id: Date.now() });
        setPurchaseForm({ ...purchaseForm, items: newItems });
    };
        ...
        <div className={styles.container}>
            ...
            {isPurchaseModalOpen && (
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(15, 23, 42, 0.6)', backdropFilter: 'blur(4px)' }}>
                    <div style={{ backgroundColor: '#ffffff', width: '95vw', maxWidth: '1400px', borderRadius: '12px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', overflow: 'hidden', display: 'flex', flexDirection: 'column', maxHeight: '90vh' }}>
